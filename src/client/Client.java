        ...
        private Message connectionServer(Message message_server) {
            ...
            while(true) {
                try {
                    ...
                    verify = true;
                    System.out.println("ERRORE: Impossibile connettersi al server, " + ce);
                    Platform.runLater(new Runnable() {
                        @Override
                        public void run() {
                    ...
                    try {
                        ...
                        System.out.println("ERRORE: Generato nel Thread del Client, " + ex);
                    }
                } catch (Exception ex2) {
                    System.out.println("ERRORE: Generato nel client, " + ex2);
                } finally {
                    try {
                        ...
                        System.out.println("ERRORE: Chiusura del socket fallita, " + ex3);
                    }
                }
            }
        }
